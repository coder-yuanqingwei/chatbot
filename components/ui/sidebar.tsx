  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={toggleSidebar}
        className={cn(
          "absolute left-3 h-[6px] w-4 cursor-e-resize",
          isCollapsed ? "top-0" : "top-[calc(3.5rem-6px)] cursor-w-resize"
        )}
      />
      <div className={cn(
        "pointer-events-none absolute bottom-0 left-0 w-4 rounded-tl-[12px] border-t border-l border-sidebar-border opacity-0 transition-opacity duration-150 group-hover/rail:opacity-100",
